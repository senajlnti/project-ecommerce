        ...
        <div class="flex-auto p-6">
          ...
          <div class="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
            <a href="#" class="flex cursor-pointer items-center gap-2 text-indigo-500 no-underline hover:text-indigo-500">
              <span class="flex-shrink-0 text-3xl font-black lowercase tracking-tight opacity-100">senaStore</span>
            </a>
          </div>
          <!-- /Logo -->
          <h4 class="mb-2 font-medium text-gray-700 xl:text-xl"> senaStore!</h4>
          <form id="" class="mb-4" @submit.prevent="performRegister">
            ...
            <div class="mb-4">
              <div class="flex justify-between">
                <label class="mb-2 inline-block text-xs font-medium uppercase text-gray-700" for="password">Confirm
                  Password</label>
              </div>
              <div class="relative flex w-full flex-wrap items-stretch">
                <input type="password" id="password"
