    ...
    <section class="bg-white py-6 sm:py-8 lg:py-12">
      <div class="mx-auto max-w-screen-xl px-4 md:px-8"> 
        ...
        <div class="mb-10 md:mb-16">
          <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">All Brands</h2>
        ...
        <div class="grid gap-8 sm:grid-cols-2 sm:gap-12 lg:grid-cols-2 xl:grid-cols-2 xl:gap-16">
          <!-- Article -->
          <div v-for="brand in getBrand.data" :key="brand.id">
          <article class="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
            ...
            <div class="flex flex-col gap-2">
              <span class="text-sm text-gray-400">{{ brand.slug }}</span>

              <h2 class="text-xl font-bold text-gray-800">
                <a href="#" class="transition duration-100 hover:text-rose-500 active:text-rose-600">{{ brand.name }}</a>
              </h2>
