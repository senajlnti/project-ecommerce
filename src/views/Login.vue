                ...
                <div class="flex-auto p-6">
                    ...
                    <div class="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
                        <a href="#"
                            ...
                            <span
                                class="flex-shrink-0 text-3xl font-black lowercase tracking-tight opacity-100">senaStore</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    ...
                    <p class="mb-4 text-center">
                        Belum punya akun?
                        <a href="/register" class="cursor-pointer text-indigo-500 no-underline hover:text-indigo-500">
                            Register</a>
                    </p>
                </div>
            </div>
